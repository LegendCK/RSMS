...
struct ManagerOperationsView: View {
    ...
    var body: some View {
        ZStack(alignment: .bottomTrailing) {
            ...
            VStack(spacing: 0) {
                // LOCK HEADER: Segmented control at a fixed top position
                ...
                .background(Color.red.opacity(0.1)) // Debug Background (Section 8)

                // CONTENT: Starts at the same Y-position for every tab
                ...
                .background(Color.red.opacity(0.05)) // Debug Background (Section 8)
            }

            // FAB: Anchored at bottom-right, overlaying the content
